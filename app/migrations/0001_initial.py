# Generated by Django 2.0.3 on 2018-04-09 20:06
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='CardType',
            fields=[
                ('id', models.PositiveIntegerField(choices=[(0, 'Navadna kartica'), (1, 'Nujna zahteva')], default=0, primary_key=True, serialize=False)),
            ],
        ),
        migrations.CreateModel(
            name='Column',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=255)),
                ('project_code', models.CharField(default='', max_length=255, null=True)),
                ('customer', models.CharField(default='', max_length=255)),
                ('date_start', models.DateField(default=django.utils.timezone.now)),
                ('date_end', models.DateField()),
                ('is_active', models.BooleanField(default=True)),
                ('board', models.ForeignKey(default=None, null=True, on_delete=django.db.models.deletion.CASCADE, to='app.Board')),
            ],
        ),
        migrations.CreateModel(
            name='Setting',
