...
p3 = Project(team=t2, name="Projekt 3", customer="Podgoršek", board=b1, project_code="PR-03")
p3.save()

p4 = Project(team=t3, name="Projekt 4", customer="Smolej", board=b1, project_code="PR-04")
p4.save()
