...
p1 = Project(team=t1, name="Projekt 1 (s karticami)", customer="Mahnic", board=None, project_code="PR-01",
             date_end=datetime.date(2018, 10, 20))
p1.save()

p2 = Project(team=t1, name="Projekt 2 (s karticami)", customer="Furst", board=None, project_code="PR-02",
             date_end=datetime.date(2018, 12, 20))
p2.save()

p3 = Project(team=t2, name="Projekt 3", customer="Podgoršek", board=None, project_code="PR-03",
             date_end=datetime.date(2018, 12, 25))
p3.save()

p4 = Project(team=t3, name="Projekt 4", customer="Smolej", board=None, project_code="PR-04",
             date_end=datetime.date(2018, 11, 25))
p4.save()
...
c3 = Card(column=col3, type=CardType.objects.get(id=1), description="Meowing all over the world.", name="Bllll",
          estimate=666, project=p2)
c3.save()
